    ...
    <footer className="py-16 bg-[#2C2420] text-[#FAF9F6]">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 border border-[#FAF9F6]/20 rounded-lg flex items-center justify-center font-serif font-bold text-xs text-[#D4A373]">DH</div>
          <span className="text-xl font-bold tracking-tight">DIGITAL HEDGE</span>
        </div>
        
        <div className="text-xs text-[#FAF9F6]/50 tracking-widest uppercase">
          © {new Date().getFullYear()} Digital Hedge Co., Ltd. The Art of Digital Extraction.
        </div>
