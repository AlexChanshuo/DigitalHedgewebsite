                ...
                <div className="flex items-center gap-2 mt-2">
                  {post.author.publicEmail && (
                    <a
                      ...
                      title={post.author.publicEmail}
                      className="w-8 h-8 rounded-full bg-[#FAF9F6] border border-[#E0E0E0] flex items-center justify-center text-[#2C2420]/60 hover:text-[#D4A373] hover:border-[#D4A373] transition-colors"
                    >
